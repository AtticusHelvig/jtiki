...
class Parser {
    /**
     * Static class used when the Parser gets confused about the state of the code
     */
    ...
    /**
     * Main functionality of Parser
     * Parses through its list of tokens
     *
     * @return the list of statements generated by the Parser
     */
    List<Stmt> parse() {
    ...
    /**
     * Helper method to parse a function, reused for methods
     */
    ...
    /**
     * Given a TokenType, consume it if it exists; otherwise, throw an error
     *
     * @throws ParseError
     */
    ...
    /**
     * Attempt to advance to the next available statement
     * Useful for when the Parser gets confused
     */
